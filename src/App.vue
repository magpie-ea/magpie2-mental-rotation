  ...
  <Experiment :title="'Mental rotation experiment'">
    ...
    <InstructionScreen :title="'Instructions'">
      <p>
        ...
        or different. You will need press button "F" if you think the objects
        are the same, and "J" if you think they are different. Please try to
        answer as quick and accurately as possible!
      </p>
